          ...
          {showClothingDropdown && (
            ...
            >
              ...
              <div>
                ...
                <ul className="space-y-1">
                  <li><Link to="/clothing?search=Gigi's+Favorite+Collection" onClick={handleDropdownLinkClick} className="block py-1 hover:text-gray-500">Gigi's Favorite Collection</Link></li>
